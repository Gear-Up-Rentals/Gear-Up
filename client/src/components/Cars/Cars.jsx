      ...
      <div className="carsContainer">
        <div className="carsWrapper">
          ...
          <div className="carsWrapper2">
            ...
            <span>
              <p
                className={sortCriteria === "-rating" ? "active" : ""}
                onClick={() => setSortCriteria("-rating")}
              >
                Top Rating
              </p>
              <p
                className={sortCriteria === "hourlyPrice" ? "active" : ""}
                onClick={() => setSortCriteria("hourlyPrice")}
              >
                Hourly Rate
              </p>
            </span>
            {topData.length !== 0 &&
              topData.map((el, index) => (
                <div
                  className="carInfo"
                  key={index}
                  onClick={() => navigate(`/confirm/${el._id}`)}
                >
        ...
        <div className="carsSearch">
          ...
          {filterData.length === 0 && (
            <div className="no-cars-found grid">NO CARS FOUND!</div>
          )}
        </div>
      </div>
    </>
